...
const translations = {
  en: {
    ...
    'hero.eyebrow': 'AI strategy · product · research',
    'hero.title': 'AI',
    ...
    'about.manifesto': 'Self-evolving.',
    'photo.title': 'Through My Lens',
    ...
    'exp.xhs.items': '<li>Deep-dive research on AI Coding, embodied intelligence, and OpenClaw \u2014 reports endorsed by executives</li><li>Built <strong>Frontier Insight Bot</strong> with Claude Code: automated intelligence pipeline covering <span data-countup>250</span>+ global AI sources, delivering daily briefs & weekly strategic reports</li><li>Led internal AI workshops on Vibe Coding; packaged workflows into Skills with <span data-countup>100</span>+ downloads on company platform</li><li>Authored strategic business reports driving decisions across security, risk control, and operational efficiency</li>',
    ...
    'proj.clawd.desc': 'Personal AI secretary & knowledge management system. Dual-domain wiki (work/life), automated knowledge ingestion, daily standups, Socratic coaching mode, and self-evolving context accumulation.',
    'proj.haoling.badge': '🏆 Hackathon Winner',
    'proj.haoling.desc': '1st place (Shanghai) at Douyin AI Hackathon 2026, advancing to the regional finals. Five lightweight 玄学 (mysticism) cards embedded in the Douyin feed — zodiac, shake-for-divination, daily fortune, answer book, and tarot. Designed around ritual gestures, scarcity, and conditional triggers. Team lead — drove product vision, design, and narrative; contributed to frontend development and the final pitch.',
    'proj.haoling.demo': 'Live Demo',
    'proj.haoling.doc': 'Product Doc',
    'proj.dreamhome.badge': 'Regional Finalist',
    'proj.dreamhome.desc': 'Created for the regional competition track “Content Reconstruction × AI Interpretation,” DreamHome extracts interior-design elements from home-renovation videos, transforms 2D elements into 3D components, and lets users assemble and reconstruct them in a personal 3D space. Selected as a finalist from 50+ entries.',
    'proj.dreamhome.link': 'View Project',
    'proj.misinfo.title': 'Social Media Misinformation Detector',
    'proj.misinfo.desc': '<ul><li>5,284 tweets → True / False / Other 三分类</li><li>4,000+ NLP 特征：TF-IDF, sentiment, URL analysis, linguistic patterns</li><li>Best model: SVM — 77% acc, 0.88 AUC</li><li><strong>Best Technology Award</strong></li></ul>',
    'proj.website.title': 'Personal Website with Dual AI Chatbot',
    'proj.website.desc': '<ul><li>Self-built RAG pipeline, from scratch</li><li>Embedding: BGE-M3 (1024-dim, bilingual)</li><li>Vector DB: Supabase pgvector, 1,000+ chunks</li><li>Generation: DeepSeek V3, multi-turn</li><li>Deploy: Vercel Edge Functions + GitHub Pages</li></ul>',
  ...
  zh: {
    ...
    'exp.xhs.items': '<li>\u805a\u7126 AI Coding\u3001\u5177\u8eab\u667a\u80fd\u3001OpenClaw \u7b49\u524d\u6cbf\u9886\u57df\u6df1\u5ea6\u7814\u7a76\u2014\u2014\u62a5\u544a\u83b7\u9ad8\u7ba1\u70b9\u8d5e</li><li>\u57fa\u4e8e Claude Code \u72ec\u7acb\u5f00\u53d1 Frontier Insight Bot\uff1a\u8986\u76d6 <span data-countup>250</span>+ \u5168\u7403 AI \u4fe1\u6e90\u7684\u81ea\u52a8\u5316\u60c5\u62a5\u7cfb\u7edf\uff0c\u65e5\u63a8\u65e5\u62a5\u3001\u5468\u51fa\u6218\u7565\u5468\u62a5</li><li>\u53d7\u9080\u4e3e\u529e\u5185\u90e8 Vibe Coding Workshop\uff1b\u5c06\u91cd\u590d\u6d41\u7a0b\u5c01\u88c5\u4e3a Skill\uff0c\u4e0a\u67b6\u516c\u53f8 Skill Market\uff0c\u8d85 <span data-countup>100</span> \u6b21\u4e0b\u8f7d</li><li>\u8f93\u51fa\u6218\u7565 BP \u62a5\u544a\uff0c\u843d\u5730\u81f3\u5b89\u5168\u98ce\u63a7\u3001\u5185\u90e8\u6548\u7387\u63d0\u5347\u7b49\u591a\u4e2a\u573a\u666f</li>',
    ...
    'proj.clawd.desc': '个人 AI 秘书 & 知识管理系统。双域 wiki（工作/生活）、自动知识摄入、每日站会、苏格拉底式教练模式、自进化上下文积累。',
    'proj.haoling.badge': '🏆 黑客松冠军',
    'proj.haoling.desc': '抖音 AI 创变者黑客松上海站第一名，入围 7 月底大区赛。5 张轻量玄学卡片嵌入抖音信息流——生肖年运 / 摇签求签 / 今日运势 / 答案之书 / 塔罗占卜，主打仪式感手势、稀缺感与条件式触发。担任队长，主导产品理念、设计与故事线撰写，参与前端开发与产品路演。',
    'proj.haoling.demo': '在线体验',
    'proj.haoling.doc': '产品文档',
    'proj.dreamhome.badge': '大区赛决赛入围',
    'proj.dreamhome.desc': '大区赛针对赛题“内容重构 × AI 解析”，设计产品《理想家》，帮助用户从家装视频中提取家装元素，将平面元素转化为 3D 组件，并支持在个人 3D 空间中对组件进行组装重构，从 50+ 组作品中入围决赛。',
    'proj.dreamhome.link': '点击查看作品',
    'proj.misinfo.title': '社媒 UGC 真假信息识别模型',
    'proj.misinfo.desc': '<ul><li>5,284 条推文 → 真/假/其他 三分类</li><li>构建 4,000+ 维 NLP 特征：TF-IDF、情感分析、URL 分析、语言学模式</li><li>最佳模型 SVM：准确率 77%，AUC 0.88</li><li><strong>最佳技术奖</strong></li></ul>',
    'proj.website.title': '个人网站 · 双 AI Chatbot',
    'proj.website.desc': '<ul><li>从零独立构建 RAG 管线</li><li>向量化：BGE-M3（1024 维，中英双语）</li><li>向量库：Supabase pgvector，1,000+ 知识块</li><li>生成：DeepSeek V3，支持多轮对话</li><li>部署：Vercel Edge Functions + GitHub Pages</li></ul>',
