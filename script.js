...
const translations = {
  ...
  zh: {
    ...
    'proj.haoling.desc': '抖音黑客松一等奖。5 张轻量玄学卡片嵌入抖音信息流——生肖年运 / 摇签求签 / 今日运势 / 答案之书 / 塔罗占卜，主打仪式感手势、稀缺感与条件式触发。负责着陆页、产品理念整理、部署整合与仓库管理。',
