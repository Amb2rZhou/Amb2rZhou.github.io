...
const translations = {
  en: {
    ...
    'proj.misinfo.desc': 'Classified 5,284 tweets into True/False/Other using NLP. Engineered 4,000+ features (TF-IDF, sentiment, URL analysis, linguistic patterns). Best model: SVM — 77% accuracy, 0.88 AUC. <strong>Best Technology Award.</strong>',
    'proj.website.title': 'Personal Website with Dual AI Chatbot',
    'proj.website.desc': 'Full-stack site with self-built RAG pipeline. BGE-M3 embeddings → Supabase pgvector (1,000+ chunks) → DeepSeek V3 generation. Multi-turn conversation, bilingual UI, Vercel Edge Functions. Built entirely from scratch.',
  ...
  zh: {
    ...
    'proj.misinfo.desc': '对 5,284 条推文进行真/假/其他三分类。构建 4,000+ 维 NLP 特征（TF-IDF、情感分析、URL 分析、语言学模式）。最佳模型 SVM：准确率 77%，AUC 0.88。<strong>最佳技术奖。</strong>',
    'proj.website.title': '个人网站 · 双 AI Chatbot',
    'proj.website.desc': '全栈网站，自建 RAG 管线。BGE-M3 向量化 → Supabase pgvector（1,000+ 知识块）→ DeepSeek V3 生成。支持多轮对话、中英双语，Vercel Edge Functions 部署。从零独立构建。',
