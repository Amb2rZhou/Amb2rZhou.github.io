...
const translations = {
  en: {
    ...
    'proj.haoling.desc': '1st place at Douyin Hackathon 2026. Five lightweight 玄学 (mysticism) cards embedded in the Douyin feed — zodiac, shake-for-divination, daily fortune, answer book, and tarot. Designed around ritual gestures, scarcity, and conditional triggers. Team lead — drove product vision, design, and narrative; contributed to frontend development and the final pitch.',
  ...
  zh: {
    ...
    'proj.haoling.desc': '抖音黑客松一等奖。5 张轻量玄学卡片嵌入抖音信息流——生肖年运 / 摇签求签 / 今日运势 / 答案之书 / 塔罗占卜，主打仪式感手势、稀缺感与条件式触发。担任队长，主导产品理念、设计与故事线撰写，参与前端开发与产品路演。',
